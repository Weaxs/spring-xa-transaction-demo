...
import org.weaxsey.spring.boot.bitronix.demo.repository.buyer.BuyerDatasourceProperties;
...
@EnableJpaRepositories(basePackages = "org.weaxsey.spring.boot.bitronix.demo.repository.buyer",
...
public class BuyerDatabaseConfiguration {
    ...
    public DataSource buyerDataSource()
        ...
        dataSource.setUniqueName("buyerXaDs");
    ...
    public LocalContainerEntityManagerFactoryBean buyerEntityManager(DataSource buyerDataSource) {
        ...
        entityManager.setPackagesToScan("org.weaxsey.spring.boot.bitronix.demo.domain.buyer");
