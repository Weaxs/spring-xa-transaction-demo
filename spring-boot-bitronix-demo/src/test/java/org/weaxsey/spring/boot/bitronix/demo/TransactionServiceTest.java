...
package org.weaxsey.spring.boot.bitronix.demo;
...
import org.weaxsey.spring.boot.bitronix.demo.service.TransactionService;
...
public class TransactionServiceTest {
    ...
    void buyTest() {
        ...
        buyer.setName("buyer-btm-1");
        buyer.setAge(22);
        buyer.setMoney(1000);
        Seller seller = new Seller();
        seller.setName("seller-btm-1");
        seller.setAge(22);
    ...
    void buyWithExceptionTest() {
        Buyer buyer = new Buyer();
        buyer.setName("buyer-btm-2");
        buyer.setAge(22);
        buyer.setMoney(1000);
        Seller seller = new Seller();
        seller.setName("seller-btm-2");
        seller.setAge(22);
        seller.setMoney(1000);
